...
//                },
                ...
                },
                {
                        ...
                        "নির্বিষ।",
                        "সিংহরা সাধারণত মাঝারি আকারের থেকে বৃহৎ খুরওয়ালা প্রাণীদের শিকার করে এবং খায় যেমন wildbeests, zebras, and antelopes. এরা মাঝে মাঝে বড় প্রাণীদের শিকার করে, বিশেষ করে অসুস্থ বা আহতদের, এবং ক্যারিয়ানের মতো পাওয়া মাংস খায়।",
                        "খোলা সমভূমি থেকে পুরু বুরুশ এবং শুষ্ক কাঁটা বন পর্যন্ত সিংহরা বিস্তৃত আবাসস্থলে বাস করে। উত্তর-পশ্চিম ভারতের গির বনে রয়ে যাওয়া ভারতীয় সিংহের উপ-প্রজাতির একটি ক্ষুদ্র জনসংখ্যা ছাড়া, সিংহরা এখন কেবল আফ্রিকাতেই বাস করে, সাহারার দক্ষিণ প্রান্ত থেকে উত্তর দক্ষিণ আফ্রিকা পর্যন্ত।",
                        "সিংহ হল আফ্রিকা ও ভারতে বসবাসকারী প্যানথেরা গোত্রের একটি বড় বিড়াল। এটি একটি পেশীবহুল, প্রশস্ত বুকের শরীর আছে; ছোট, গোলাকার মাথা; গোলাকার কান; এবং এর লেজের শেষে একটি লোমশ টুফ্ট। এটা সেক্সুয়ালি ডাইমরফিক; প্রাপ্তবয়স্ক পুরুষ সিংহগুলি মহিলাদের চেয়ে বড় এবং একটি বিশিষ্ট ম্যান আছে।"
                },
...

                {
                        ...
                        "এটি ঘন বা খোলা বন, সমভূমি, কৃষি জমি (ধানের ক্ষেত, গমের ফসল), পাথুরে ভূখণ্ড, জলাভূমিতে পাওয়া যেতে পারে এবং এটি এমনকি গ্রাম এবং শহরের উপকণ্ঠের মতো ভারী জনবহুল শহুরে এলাকায়ও পাওয়া যেতে পারে। সমুদ্রপৃষ্ঠ থেকে 2,000 মিটার (6,600 ফুট) উচ্চতায়।",
                        "এটি কিং কোবরা নয়, এটি খুব বিষাক্ত এবং মানুষকে হত্যা করে।"
                },
