        ...
        public static String[][] DETAILS = new String[][]{
                ...
                },
                {
                        ...
                        "গোল্ডফিশ (ক্যারাসিয়াস অরাটাস) হল সাইপ্রিনিফর্মের সাইপ্রিনিডি পরিবারের একটি মিঠা পানির মাছ।" +
                                ...
                                "1,000 বছরেরও বেশি আগে সাম্রাজ্য চীনে এটি প্রথম বেছে বেছে রঙের জন্য প্রজনন করা হয়েছিল,\" +\n" +
                ...
                },
                {
                        ...
                        "The great white shark (Carcharodon carcharias), also known as the white shark, white pointer, or simply great white, " +
                                ...
                                "1,200 m (3,900 ft).",
                        "অবিষাক্ত",
                        "মহান সাদা হাঙর (Carcharodon carcharias), যা হোয়াইট হাঙ্গর, হোয়াইট পয়েন্টার বা সহজভাবে মহান সাদা নামেও পরিচিত, \"\n" +
                                "                            \"বড় ম্যাকেরেল হাঙরের একটি প্রজাতি যা সমস্ত প্রধান মহাসাগরের উপকূলীয় পৃষ্ঠের জলে পাওয়া যায়।\"\n" +
                                "                            \"এটি তার আকারের জন্য উল্লেখযোগ্য, বড় মহিলা ব্যক্তিদের দৈর্ঘ্য 6.1 মিটার (20 ফুট) পর্যন্ত বৃদ্ধি পায় এবং \"\n" +
                                "                            \"1,905-2,268 কেজি (4,200-5,000 পাউন্ড) পরিপক্কতার সময় ওজন। তবে, বেশিরভাগই ছোট;\"\n" +
                                "                            \" পুরুষদের পরিমাপ 3.4 থেকে 4.0 মিটার (11 থেকে 13 ফুট), এবং মহিলারা 4.6 থেকে 4.9 মিটার (15 থেকে 16 ফুট) গড়ে।\"\n" +
                                "                            \"2014 সালের একটি সমীক্ষা অনুসারে, মহান সাদা হাঙরের জীবনকাল 70 বছর বা তার বেশি হতে পারে বলে অনুমান করা হয়।\"\n" +
                                "                            \"পূর্ববর্তী অনুমানের উপরে, এটি বর্তমানে পরিচিত সবচেয়ে দীর্ঘজীবী কার্টিলাজিনাস মাছগুলির মধ্যে একটি।\"\n" +
                                "                            \"একই সমীক্ষা অনুসারে, পুরুষ মহান সাদা হাঙর যৌন পরিপক্কতা পেতে 26 বছর সময় নেয়,\"\n" +
                                "                            \"যদিও নারীদের সন্তান উৎপাদনের জন্য প্রস্তুত হতে 33 বছর সময় লাগে।\"\n" +
                                "                            \"দারুণ সাদা হাঙররা 25 কিমি/ঘন্টা (16 মাইল প্রতি ঘণ্টা) [10] গতিতে সাঁতার কাটতে পারে এবং এর গভীরতায়\n" +
                                "                            \"1,200 মি (3,900 ফুট)।"
